...
/**
 * Options for configuring Remark GitHub Alerts plugin.
 * @typedef {Object} RemarkGitHubAlertsOptions
 * @property {string[] | "*"} [markers=['TIP', 'NOTE', 'IMPORTANT', 'WARNING', 'CAUTION']] - List of markers to match.
 * @property {boolean} [matchCaseSensitive=true] - If markers case sensitively on matching.
 * @property {Record<string, string>} [icons] - Custom icons for each marker.
 * @property {Record<string, string>} [titles] - Custom titles for each marker.
 * @property {string} [classPrefix='markdown-alert'] - Prefix for the class names.
 * @property {boolean} [ignoreSquareBracket=false] - Whether to ignore the square brackets in the marker.
 */
/**
